<template>
    <el-main class="카테고리" id="winter->젊음->저녁">
        <br><br>
        ...
        <br><br>
             <h3>숯불에 소고기 치그작치그작 구워 한점~?</h3>

        <a href="http://localhost:8080/#/home" target="_parent"><img src="../../ex_img/sogo.jpg" width="500" height="300" align="center"> </a>
