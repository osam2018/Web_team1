<template>
    <el-main class="카테고리" id="봄가을->늙음->저">
        <br><br>
        ...
        <br><br>
         <h3>파닥파닥 싱싱한 대하소금구이</h3>

        <a href="http://localhost:8080/#/home" target="_parent"><img src="../../ex_img/dinner2.jpg" width="500" height="300" align="center"> </a>
