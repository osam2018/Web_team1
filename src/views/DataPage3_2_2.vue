<template>
    <el-main class="카테고리" id="winter->old->점">
        <br><br>
        ...
        <br><br>
             <h3>등산하고 와서 시원한 바지락 칼국수 국물 후루룩!</h3>

        <a href="http://localhost:8080/#/home" target="_parent"><img src="../../ex_img/baji.jpg" width="500" height="300" align="center"> </a>
